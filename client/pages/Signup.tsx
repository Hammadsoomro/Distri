        ...
        <CardContent>
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@example.com" className="bg-white/10 text-white border-white/20 placeholder:text-white/40" required />
            </div>
            <div>
            ...
            <Button type="submit" disabled={loading} className="w-full">{loading ? "Creating..." : "Create Admin"}</Button>
          </form>
        </CardContent>
      </Card>
    </div>
